...
public class Regex {
    ...
    public static final List<String> SPECIAL_SYMBOL  = Arrays.asList("+","-","*", "(", ")", "[", "]", ":=", ".", ",", ";", ":", "..","div", "or", "and", "not" ,"if" ,"then", "else", "of", "while", "do", "begin", "end",
...
//    public static
    ...
    public static final String IDENTIFIER = "[a-zA-Z]+[0-9]*[a-zA-Z]*";
